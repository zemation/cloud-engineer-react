...
const About = () => {
  return (
    ...
    <div id="about">
      ...
      <p>Hello and welcome. My name is Robert. I am husband and father of two young men. I have been in the technical field for over 20 years, starting with working towards/achieving my CompTIA A+ Certification in 1999. Since that time I have worked several local and global companies.</p>
